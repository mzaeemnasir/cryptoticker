...
- **Large ASCII price display** - Current price rendered in bold `banner3` block font via the `art` library, color-coded green/red
...
- `art` - Large ASCII price display (banner3 block font)
